...
@Component({
    selector: 'app-regular-table6F',
    templateUrl: './regular-table6F.component.html',
    styleUrls: ['./regular-table6F.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent6F implements OnInit {
