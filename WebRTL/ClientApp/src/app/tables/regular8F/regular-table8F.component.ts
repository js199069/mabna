...
@Component({
    selector: 'app-regular-table8F',
    templateUrl: './regular-table8F.component.html',
    styleUrls: ['./regular-table8F.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent8F implements OnInit {
