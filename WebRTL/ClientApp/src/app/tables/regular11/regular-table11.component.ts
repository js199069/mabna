...
@Component({
    selector: 'app-regular-table11',
    templateUrl: './regular-table11.component.html',
    styleUrls: ['./regular-table11.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent11 implements OnInit{
