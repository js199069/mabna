...
@Component({
    selector: 'app-regular-tableF',
    templateUrl: './regular-tableF.component.html',
    styleUrls: ['./regular-tableF.component.scss']
})

export class RegularTableComponentF implements OnInit{
