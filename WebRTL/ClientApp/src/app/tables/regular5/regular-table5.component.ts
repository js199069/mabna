...
@Component({
    selector: 'app-regular-table5',
    templateUrl: './regular-table5.component.html',
    styleUrls: ['./regular-table5.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent5 implements OnInit{
