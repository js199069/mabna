...
@Component({
    selector: 'app-regular-table10',
    templateUrl: './regular-table10.component.html',
    styleUrls: ['./regular-table10.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent10 implements OnInit{
