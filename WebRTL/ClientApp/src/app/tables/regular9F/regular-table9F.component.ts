...
@Component({
    selector: 'app-regular-table9F',
    templateUrl: './regular-table9F.component.html',
    styleUrls: ['./regular-table9F.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent9F implements OnInit {
