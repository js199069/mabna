...
@Component({
    selector: 'app-regular-table3',
    templateUrl: './regular-table3.component.html',
    styleUrls: ['./regular-table3.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent3 implements OnInit{
