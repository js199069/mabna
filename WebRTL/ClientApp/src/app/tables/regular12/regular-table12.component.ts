...
@Component({
    selector: 'app-regular-table12',
    templateUrl: './regular-table12.component.html',
    styleUrls: ['./regular-table12.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent12 implements OnInit {
    ...
    ngOnInit() {//form validation
        this.regularForm = new FormGroup({
            ...
            'input12': new FormControl(null, [Validators.required, Validators.pattern(/^[.\d]+$/)]),
