...
@Component({
    selector: 'app-regular-table13',
    templateUrl: './regular-table13.component.html',
    styleUrls: ['./regular-table13.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent13 implements OnInit {
