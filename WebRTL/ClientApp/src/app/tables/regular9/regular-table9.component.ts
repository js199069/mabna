...
@Component({
    selector: 'app-regular-table9',
    templateUrl: './regular-table9.component.html',
    styleUrls: ['./regular-table9.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent9 implements OnInit{
