...
@Component({
    selector: 'app-regular-table7F',
    templateUrl: './regular-table7F.component.html',
    styleUrls: ['./regular-table7F.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent7F implements OnInit {
