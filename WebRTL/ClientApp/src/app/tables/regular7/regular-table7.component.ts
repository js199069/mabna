...
@Component({
    selector: 'app-regular-table7',
    templateUrl: './regular-table7.component.html',
    styleUrls: ['./regular-table7.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent7 implements OnInit{
