...
@Component({
    selector: 'app-regular-table4F',
    templateUrl: './regular-table4F.component.html',
    styleUrls: ['./regular-table4F.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent4F implements OnInit {
