...
@Component({
    selector: 'app-regular-table6',
    templateUrl: './regular-table6.component.html',
    styleUrls: ['./regular-table6.component.scss']
})
@NgModule({
    imports: [
...
export class RegularTableComponent6 implements OnInit{
